...
PinDescription g_APinDescription[TOTAL_GPIO_PIN_NUM]=
{
    ...
    {PF_8, 	TYPE_DIGITAL,               PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM | PIO_SPI         	, MODE_NOT_INITIAL}, // AMB_D7		SPI1_SS
    {PF_7, 	TYPE_DIGITAL,               PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM | PIO_SPI          	, MODE_NOT_INITIAL}, // AMB_D8		SPI1_MOSI	
    {PF_6,  TYPE_DIGITAL, 				PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM | PIO_SPI           	, MODE_NOT_INITIAL}, // AMB_D9     	SPI1_CLK
    {PF_5,  TYPE_DIGITAL, 				PIO_GPIO | PIO_GPIO_IRQ | PIO_SPI          		, MODE_NOT_INITIAL}, // AMB_D10    	SPI1_MISO
